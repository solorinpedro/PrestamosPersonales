...
import edu.ucne.prestamospersonales.view.Prestramo.PrestamoViewModel
import java.util.*

@OptIn(ExperimentalMaterialApi::class)
@Composable
fun RegistroPrestamos(backToDashboard:() -> Unit, viewModel: PrestamoViewModel = hiltViewModel()) {
