...
import edu.ucne.prestamospersonales.view.Persona.PersonaViewModel
import java.util.*
            ...
            ExposedDropdownMenuBox(
                ...
                onClick = {
                    ...
                    if(viewModel.Nombres == ""){
                        Toast.makeText(context, "Nombre no debe estar vácio", Toast.LENGTH_SHORT).show()
                    }
                    if(viewModel.Telefono.toString() == ""){
                        Toast.makeText(context, "Telefono no debe estar vacio", Toast.LENGTH_SHORT).show()
                    }
                    if(viewModel.Celular.toString() == ""){
                        Toast.makeText(context, "Celular no debe estar vacio", Toast.LENGTH_SHORT).show()
                    }
                    if(viewModel.Email.toString() == ""){
                        Toast.makeText(context, "Email no debe estar vacio", Toast.LENGTH_SHORT).show()
                    }
                    if(viewModel.Direccion.toString() == ""){
                        Toast.makeText(context, "Direccion no debe estar vacio", Toast.LENGTH_SHORT).show()
                    }
